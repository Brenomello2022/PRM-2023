import { Body, ClassSerializerInterceptor, Controller, HttpCode, HttpException, 
HttpStatus, Post, UnauthorizedException, UseInterceptors } from "@nestjs/common";
...
export class AuthController {
    ...
    async signUp (@Body() user: User): Promise<User>{
        ...
        if (found) {
            throw new HttpException('Este nome usuário ja está em uso.', HttpStatus.CONFLICT
